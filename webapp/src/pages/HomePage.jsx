  ...
  return (
    <div className="min-h-screen" style={{ display: 'flex', flexDirection: 'column' }}>
      ...
      <div className="container" style={{
        flex: '1 0 auto',
        paddingTop: window.innerWidth <= 480 ? 'calc(56px + 1rem)' : 'calc(60px + 1.5rem)',
        paddingBottom: '2rem',
        paddingLeft: '1rem',
        paddingRight: '1rem'
      }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '1rem', alignItems: 'center', opacity: 0.6 }}>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              style={{ color: 'var(--text-secondary)', textDecoration: 'none', fontSize: '0.75rem' }}
            >
              {t('imprint')}
            </a>
            <a
            ...
            <span style={{ fontSize: '0.7rem', opacity: 0.5 }}>v2.9.0</span>
          </div>
        </div>
      </footer>
