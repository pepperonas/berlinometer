...
const translations = {
  [LANGUAGES.DE]: {
    ...
    'registrationSuccess': 'Registrierung erfolgreich! Bitte prüfe dein E-Mail-Postfach und bestätige deine E-Mail-Adresse.',
    ...
    'activationNote': 'Nach der Registrierung erhältst du eine E-Mail mit einem Bestätigungslink. Klicke darauf, um deinen Account zu aktivieren.',
    'noteLabel': 'Hinweis:',
    'accountVerified': 'Dein Account wurde erfolgreich verifiziert! Du kannst dich jetzt anmelden.',
    'verificationFailed': 'Die Verifizierung ist fehlgeschlagen. Der Link ist ungültig oder wurde bereits verwendet.',
  ...
  [LANGUAGES.EN]: {
    ...
    'registrationSuccess': 'Registration successful! Please check your email inbox and verify your email address.',
    ...
    'activationNote': 'After registering, you will receive an email with a verification link. Click it to activate your account.',
    'noteLabel': 'Note:',
    'accountVerified': 'Your account has been verified successfully! You can now log in.',
    'verificationFailed': 'Verification failed. The link is invalid or has already been used.',
