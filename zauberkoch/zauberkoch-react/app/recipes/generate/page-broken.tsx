          ...
          >
            ...
            <div className="space-y-6">
              ...
              >
                ...
                maßgeschneiderte Rezepte für dich.
              </motion.p>
            </div>
            ...
            <div className="space-y-16">
              ...
              >
                ...
                <RadioGroup
                  ...
                  description="Wähle deine bevorzugte Ernährungsform"
                  layout="horizontal"
                  size="lg"
                />
              </motion.div>
              ...
              >
                ...
                <CheckboxGroup
                  ...
                  label="Dein Ziel 💕"
                  description="Was möchtest du mit deiner Ernährung erreichen?"
                  layout="grid"
                  size="md"
                  minSelections={1}
                  maxSelections={3}
              ...
              >
                ...
                <div className="relative z-10 space-y-8">
                  <div className="text-center">
                    ...
                    <p className="text-text-secondary">Passe deine Vorlieben an deine Bedürfnisse an</p>
                  </div>
              ...
              >
                ...
                <TagInput
                  ...
                  description="Beschreibe, was du dir wünschst - Zutaten, Stil, Geschmack..."
                  suggestions={WISHES_SUGGESTIONS}
                  maxTags={5}
                />
              </motion.div>

              {/* Länderküche und Mahlzeit */}
              <motion.div
                variants={itemVariants}
              ...
              >
                ...
                <div className="card card-glass p-8 border border-primary/15 hover:border-primary/30 transition-all duration-300 group">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-lg font-semibold text-gray-900">Länderküche</h3>
                ...
                <div className="card card-glass p-8 border border-secondary/15 hover:border-secondary/30 transition-all duration-300 group">
                  ...
                  <RadioGroup
                    ...
                    label="Mahlzeit"
                    description="Für welche Tageszeit?"
                    layout="vertical"
                    size="sm"
                  />
                </div>
                ...
                <div className="relative z-10 space-y-6">
                  <div className="space-y-4">
                    ...
                    <p className="text-text-secondary max-w-md mx-auto">
                      Unsere KI erstellt in Sekunden ein maßgeschneidertes Rezept basierend auf deinen Einstellungen.
                    </p>
                  </div>
            ...
            >
                ...
                <div className="relative z-10 mb-10">
                  <div className="flex items-center gap-5 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary text-lg">Für {recipe.servings} köstliche Portionen</p>
                    </div>
                  </div>
                </div>
              ...
              >
                ...
                <div className="relative z-10 mb-10">
                  <div className="flex items-center gap-5 mb-4">
                    ...
                    <div>
                      <h3 className="text-3xl font-black text-text-primary">Schritt-für-Schritt Anleitung</h3>
              ...
              >
                ...
                <div className="relative z-10 space-y-8">
                  ...
                  >
                    <span className="text-lg animate-spin">✨</span>
                    <span>Powered by OpenAI GPT-4 • Personalisiert für dich</span>
                    <span className="text-lg animate-spin">⚡</span>
                  </motion.div>
