...
export default function RecipeGeneratePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Rezept erfolgreich generiert! 🍽️');
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        ...
        <div className="relative z-10">
          ...
          >
            <div className="text-8xl mb-8 filter drop-shadow-lg animate-bounce">🍳</div>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <span className="bg-gradient-to-r from-secondary-400 to-primary-400 bg-clip-text text-transparent">
                  fuer jeden Geschmack
                </span>
                <span className="text-5xl lg:text-6xl ml-4">🎨</span>
              </motion.h1>
              ...
              >
                ...
                massgeschneiderte Rezepte für dich.
              </motion.p>
            </div>
            ...
            <div className="space-y-16">
              ...
              >
                ...
                <RadioGroup
                  ...
                  label="Ernaehrungsweise"
                  description="Waehle deine bevorzugte Ernaehrungsform"
                  layout="horizontal"
                  size="lg"
                />
              </motion.div>
              ...
              >
                ...
                <CheckboxGroup
                  ...
                  label="Dein Ziel 💕"
                  description="Was moechtest du mit deiner Ernaehrung erreichen?"
                  layout="grid"
                  size="md"
                  minSelections={1}
                  maxSelections={3}
              ...
              >
                ...
                <div className="relative z-10 space-y-8">
                  <div className="text-center">
                    ...
                    <p className="text-text-secondary">Passe deine Vorlieben an deine Beduerfnisse an</p>
                  </div>
              ...
              >
                ...
                <TagInput
                  label="Deine Wuensche"
                  icon="🔥"
                  value={formData.wishes}
                  onChange={(wishes) => updateField('wishes', wishes)}
                  placeholder="z. B. Pasta, Thai, scharf, oder Omas Auflauf…"
                  description="Beschreibe, was du dir wuenschst - Zutaten, Stil, Geschmack..."
                  suggestions={WISHES_SUGGESTIONS}
                  maxTags={5}
                />
              </motion.div>

              {/* Laenderkueche und Mahlzeit */}
              <motion.div
                variants={itemVariants}
              ...
              >
                ...
                <div className="card card-glass p-8 border border-primary/15 hover:border-primary/30 transition-all duration-300 group">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-lg font-semibold text-gray-900">Laenderkueche</h3>
                ...
                <div className="card card-glass p-8 border border-secondary/15 hover:border-secondary/30 transition-all duration-300 group">
                  ...
                  <RadioGroup
                    ...
                    label="Mahlzeit"
                    description="Fuer welche Tageszeit?"
                    layout="vertical"
                    size="sm"
                  />
                </div>
                ...
                <div className="relative z-10 space-y-6">
                  <div className="space-y-4">
                    <h3 className="text-2xl lg:text-3xl font-bold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
                      Bereit für dein perfektes Rezept?
                    </h3>
                    <p className="text-text-secondary max-w-md mx-auto">
                      Unsere KI erstellt in Sekunden ein massgeschneidertes Rezept basierend auf deinen Einstellungen.
                    </p>
                  </div>
            ...
            >
              ...
              <div className="relative card card-glow p-12 shadow-2xl border border-primary/30 bg-gradient-to-br from-surface via-surface-secondary to-surface-tertiary overflow-hidden">
                ...
                <div className="relative z-10 text-center mb-12">
                  ...
                  >
                    ...
                    <span>Generierung erfolgreich • {recipe.category || 'Hauptgericht'}</span>
                    <span className="text-lg animate-bounce">✨</span>
                  </motion.div>
                ...
                <div className="relative z-10 mb-10">
                  <div className="flex items-center gap-5 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-text-secondary text-lg">Für {recipe.servings} koestliche Portionen</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  {recipe.ingredients && recipe.ingredients.length > 0 ? (
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-on-surface-variant text-lg">Keine Zutaten verfuegbar</p>
                    </div>
                  )}
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="relative z-10 mb-10">
                  <div className="flex items-center gap-5 mb-4">
                    ...
                    <div>
                      <h3 className="text-3xl font-black text-text-primary">Schritt-fuer-Schritt Anleitung</h3>
                      <p className="text-text-secondary text-lg">Folge dieser Anleitung für perfekte Ergebnisse</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  {Array.isArray(recipe.instructions) && recipe.instructions.length > 0 ? (
                    ...
                    <div className="text-center py-12">
                      <div className="text-4xl mb-4">📋</div>
                      <p className="text-on-surface-variant text-lg">Keine Anweisungen verfuegbar</p>
                    </div>
                  )}
                </div>
              </motion.div>
              ...
              {recipe.cookingTips && (
                <div className="card p-8 shadow-lg bg-gradient-to-br from-primary/8 to-primary/3 border border-primary/30">
                  <div className="mb-6">
                    ...
                    <p className="text-primary/80 ml-14 text-sm">Fuer perfekte Ergebnisse</p>
                  </div>
                ...
                <div className="card p-8 shadow-lg border border-outline/20">
                  <div className="mb-8">
                    <div className="flex items-center gap-4 mb-2">
                      ...
                      <h3 className="text-2xl font-bold text-on-surface">Naehrwerte pro Portion</h3>
                    </div>
                    <p className="text-on-surface-variant ml-14">Detaillierte Naehrwertangaben</p>
                  </div>
              ...
              >
                ...
                <div className="relative z-10 space-y-8">
                  ...
                  >
                    <span className="text-lg animate-spin">✨</span>
                    <span>Powered by OpenAI GPT-4 • Personalisiert fuer dich</span>
                    <span className="text-lg animate-spin">⚡</span>
                  </motion.div>
