...
import $cssFromFile_1 from 'Frontend/styles/main-view.css?inline';

injectGlobalCss($cssFromFile_1.toString(), 'CSSImport end', document);
import $cssFromFile_2 from 'Frontend/generated/jar-resources/paper-slider-field.css?inline';

injectGlobalCss($cssFromFile_2.toString(), 'CSSImport end', document);
import $cssFromFile_3 from 'Frontend/styles/sparkle.css?inline';

injectGlobalCss($cssFromFile_3.toString(), 'CSSImport end', document);
import $cssFromFile_4 from 'Frontend/styles/drunk-style.css?inline';

injectGlobalCss($cssFromFile_4.toString(), 'CSSImport end', document);
import $cssFromFile_5 from 'Frontend/generated/jar-resources/paper-slider.css?inline';
