const blackStories = [
  ...
  {
    id: 78,
    title: "Der Geschäftsmann und die Entführung",
    riddle: "Ein Geschäftsmann bezeugt eine Entführung. Doch als er der Polizei berichtet, glaubt ihm keiner.",
    solution: "Der Geschäftsmann hat die Entführung im Flugzeug auf seinem Laptop-Bildschirm gesehen - es war ein Film.",
    hints: ["Laptop", "Film", "Flugzeug"]
  },
  {
    id: 79,
    title: "Zwei Boxer",
  ...
  {
    id: 101,
    title: "Frau Meyer verursacht Unfall",
    riddle: "Frau Meyer fährt auf einer großen Straße und verursacht auf der Kreuzung einen Unfall. Der andere Wagen hat einen Totalschaden. Sie wird leicht verletzt, obwohl ihr Wagen keinen Kratzer hat.",
    solution: "Frau Meyer ist Fußgängerin. Sie überquert die Straße bei Rot und verursacht dadurch, dass ein Auto ausweichen muss und gegen einen anderen Wagen fährt.",
    hints: ["Sie hat kein Auto", "Fußgängerin", "Rote Ampel"]
  },
  {
    id: 102,
