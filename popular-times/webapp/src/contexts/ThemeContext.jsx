...
export const THEME_NAMES = {
  [THEMES.DARK]: 'Dunkel',
  [THEMES.LIGHT]: 'Hell',
  [THEMES.PSYCHEDELIC]: 'Psychedelisch'
};
...
const themeConfig = {
  ...
  [THEMES.PSYCHEDELIC]: {
    name: 'Psychedelisch',
    description: 'Spektakuläres Neon-Theme',
    cssClass: 'theme-psychedelic',
    colors: {
      'background-dark': 'linear-gradient(45deg, #FF00FF, #00FFFF, #FFFF00, #FF00FF)',
