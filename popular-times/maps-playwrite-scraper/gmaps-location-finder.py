...
class BarFinder:
    ...
    async def search_bars_near_address(self, address: str) -> List[Dict]:
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                search_query = f"bars clubs kneipen biergärten near {address}"
                ...
                try:
                    ...
                    if bar_info:
                        ...
                        if self._is_likely_bar(bar_info):
                            ...
                            print(f"✅ Als Bar/Club erkannt: {bar_info['name']}")
                        else:
                            print(f"❌ Nicht als Bar/Club erkannt: {bar_info['name']}")
                    else:
    ...
    def _is_likely_bar(self, bar_info: Dict) -> bool:
        ...
        # Debug-Ausgabe
        print(f"    🔍 Name: '{name}' | Bar/Club-Keyword: {has_bar_keyword} | Ausgeschlossen: {has_exclude_keyword}")
        
        # Weniger streng: auch Restaurants/Cafés mit Bar/Club-Keywords akzeptieren
        return has_bar_keyword and not has_exclude_keyword
